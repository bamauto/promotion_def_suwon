                ...
                <div className="container mx-auto max-w-4xl">
                    ...
                    <div className="text-slate-300 space-y-8 leading-relaxed text-sm md:text-base">
                        <section>
                            ...
                            <p>
                                수원 서우실장(이하 "회사")은 다음의 목적을 위하여 개인정보를 처리합니다. 처리하고 있는 개인정보는 다음의 목적 이외의 용도로는 이용되지 않으며 이용 목적이 변경되는 경우에는 「개인정보 보호법」 제18조에 따라 별도의 동의를 받는 등 필요한 조치를 이행할 예정입니다.
                            </p>
